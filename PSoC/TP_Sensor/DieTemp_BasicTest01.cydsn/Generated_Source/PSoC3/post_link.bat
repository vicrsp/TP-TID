...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\Victor Ruela\Desktop\UFMG\2015-1\Integracao de Dados\TP pratico\TP-TID\PSoC\TP_Sensor\DieTemp_BasicTest01.cydsn\DieTemp_BasicTest01.svd" rem "C:\Users\Victor Ruela\Desktop\UFMG\2015-1\Integracao de Dados\TP pratico\TP-TID\PSoC\TP_Sensor\DieTemp_BasicTest01.cydsn\DieTemp_BasicTest01.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
